...
import ImageLandscape from "../../../../assets/starter-code/assets/technology/image-spaceport-landscape.jpg";
import ImagePortrait from "../../../../assets/starter-code/assets/technology/image-spaceport-portrait.jpg";
  ...
  return (
    <Container>
      ...
      <TextContainer>
        ...
        <h2 className="technology">SPACEPORT</h2>
